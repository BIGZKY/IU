...
Page({
  ...
  onShow: function () {
    ...
    if (wx.getStorageSync('addr_info')){
      if (wx.getStorageSync('addr_info').chooseAddrType){  // 终点
        this.setData({
          receiveAddr: wx.getStorageSync('addr_info').city.city + wx.getStorageSync('addr_info').city.district + wx.getStorageSync('addr_info').info, 
          receiveLat: wx.getStorageSync('addr_info').location.lat,
          receiveLng: wx.getStorageSync('addr_info').location.lng,

        })
        console.log(wx.getStorageSync('addr_info').location)
      }else{   //起点
        
        this.setData({
          originAddr: wx.getStorageSync('addr_info').city.city + wx.getStorageSync('addr_info').city.district + wx.getStorageSync('addr_info').info,
          originLat: wx.getStorageSync('addr_info').location.lat,
          originLng: wx.getStorageSync('addr_info').location.lng,
        })
